...
def getFilePic(picname):
    Inputimg = cv2.imread('E:\\cuiyuhao\\python\\SemanticSegmentation_AICAR\\ImageSource\\' + picname )
...
Data_batch,Label_batch=getBatchPic('E:\\cuiyuhao\\python\\dataset\\Cityscapes\\BGR512\\Cityscapes512_04.h5',900,910,getlabel=DrawLabelPic)
